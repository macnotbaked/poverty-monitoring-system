...
try {
    ...
    $program->unemployment_program_is_active = 1;
    ...
    $program->unemployment_program_created = date("Y-m-d");
    ...
    Response::sendResponse(true, "Create program for unemployment category success.",  $result);
} catch (Error $e) {
