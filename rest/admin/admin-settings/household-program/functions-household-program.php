...
function checkReadAllActive($object)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (All active household program).", []);
        exit();
    }
    return $result;
}
...
function checkReadLimitActive($object, $start, $total)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (Limit active household program).", []);
        exit();
    }
    return $result;
}
...
function checkReadSearchActive($object, $search)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (Search active household program).", []);
        exit();
    }
    return $result;
}
