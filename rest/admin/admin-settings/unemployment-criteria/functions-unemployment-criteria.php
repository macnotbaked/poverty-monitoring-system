...
function checkReadAllActive($object)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (All active unemployment criteria).", []);
        exit();
    }
    return $result;
}
...
function checkReadLimitActive($object, $start, $total)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (Limit active unemployment criteria).", []);
        exit();
    }
    return $result;
}
...
function checkReadSearchActive($object, $search)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (Search active unemployment criteria).", []);
        exit();
    }
    return $result;
}
...
function checkReadAllInactive($object)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (All inactive unemployment criteria).", []);
        exit();
    }
    return $result;
}
...
function checkReadLimitInactive($object, $start, $total)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (Limit inactive unemployment criteria).", []);
        exit();
    }
    return $result;
}
...
function checkReadSearchInactive($object, $search)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (Search inactive unemployment criteria).", []);
        exit();
    }
    return $result;
}
