...
function checkReadAllInactive($object)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (All inactive population criteria).", []);
        exit();
    }
    return $result;
}
...
function checkReadLimitInactive($object, $start, $total)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (Limit inactive population criteria).", []);
        exit();
    }
    return $result;
}
...
function checkReadSearchInactive($object, $search)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (Search inactive population criteria).", []);
        exit();
    }
    return $result;
}
