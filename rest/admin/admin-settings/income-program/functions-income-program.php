...
function checkReadAllInactive($object)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (All inactive income program).", []);
        exit();
    }
    return $result;
}
...
function checkReadLimitInactive($object, $start, $total)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (Limit inactive income program).", []);
        exit();
    }
    return $result;
}
...
function checkReadSearchInactive($object, $search)
{
    ...
    if ($result->num_rows == 0) {
        Response::sendResponse(true, "Empty Records (Search inactive income program).", []);
        exit();
    }
    return $result;
}
