...
try {
    ...
    $result = checkArchive($representative);

    Response::sendResponse(true, "Archive representative success.",  $result);
} catch (Error $e) {
    Response::sendResponse(false, "Request interrupted because a system error occured, please contact merin.ryanmark@gmail.com", $result);
}
