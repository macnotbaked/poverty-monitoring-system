...
include_once("html/html-new-application-account.php");
...
function sendEmail($email, $key)
{
	...
	$mail->isHTML(true); //getHtmlNewApplicationAccount
	$mail->Body = getHtmlNewApplicationAccount($key, ROOT_DOMAIN, IMAGES_URL);
