  ...
  return (
    <>
      <SearchBox
        ...
        result={result}
        store={store}
        url="/admin/admin-settings/income-criteria/read-search-active-income-criteria.php"
      />
      ...
      {store.isConfirm && (
        <ModalConfirm
          ...
          isDel={isDel}
          mysqlApiArchive={
            "/admin/admin-settings/income-criteria/archive-income-criteria.php"
          }
...
export default IncomeCriteriaList;
