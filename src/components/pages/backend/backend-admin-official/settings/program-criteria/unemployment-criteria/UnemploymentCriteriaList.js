...
const UnemploymentCriteriaList = ({
  loading,
  handleLoad,
  totalResult,
  result,
  ...
  return (
    <>
      <SearchBox
        ...
        result={result}
        store={store}
        url="/admin/admin-settings/unemployment-criteria/read-search-active-unemployment-criteria.php"
      />
      ...
      {store.isConfirm && (
        <ModalConfirm
          ...
          isDel={isDel}
          mysqlApiArchive={
            "/admin/admin-settings/unemployment-criteria/archive-unemployment-criteria.php"
          }
...
export default UnemploymentCriteriaList;
