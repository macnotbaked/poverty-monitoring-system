...
const InactiveUnemploymentProgramList = ({
  loading,
  handleLoad,
  totalResult,
  result,
  ...
  return (
    <>
      <SearchBox
        ...
        result={result}
        store={store}
        url="/admin/admin-settings/unemployment-program/read-search-inactive-unemployment-program.php"
      />
              ...
              result.map((item, key) => {
                ...
                return (
                  <tr key={key}>
                    ...
                    <td data-label="Name">{item.unemployment_program_name}</td>
      ...
      {store.isRestore && (
        <ModalDeleteRestore
          id={id}
          isDel={isDel}
          mysqlApiDelete="/admin/admin-settings/unemployment-program/delete-unemployment-program.php"
          mysqlApiRestore="/admin/admin-settings/unemployment-program/restore-unemployment-program.php"
          msg={
            isDel
...
export default InactiveUnemploymentProgramList;
