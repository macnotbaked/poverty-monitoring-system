...
const InactivePopulationProgramList = ({
  loading,
  handleLoad,
  totalResult,
  result,
  ...
  return (
    <>
      <SearchBox
        ...
        result={result}
        store={store}
        url="/admin/admin-settings/population-program/read-inactive-inactive-population-program.php"
      />
      ...
      {store.isRestore && (
        <ModalDeleteRestore
          id={id}
          isDel={isDel}
          mysqlApiDelete="/admin/admin-settings/population-program/delete-population-program.php"
          mysqlApiRestore="/admin/admin-settings/population-program/restore-population-program.php"
          msg={
            isDel
...
export default InactivePopulationProgramList;
