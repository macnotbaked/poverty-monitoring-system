...
import InactiveIncomeCriteriaList from "./InactiveIncomeCriteriaList";

export const InactiveIncomeCriteria = () => {
  ...
  const {
    ...
    "/admin/admin-settings/income-criteria/read-limit-inactive-income-criteria.php",
    "/admin/admin-settings/income-criteria/read-all-inactive-income-criteria.php",
                ...
                <div className="tab">
                  <div className="tab-menu">
                    ...
                    <label htmlFor="inactive-household" className="menu-label">
                      <Link
                        to={`${devNavUrl}/inactive-household-criteria`}
                        onClick={() => dispatch(setStartIndex(0))}
                      >
                        Household
                      </Link>
                    ...
                    >
                      <Link
                        to={`${devNavUrl}/inactive-unemployment-criteria`}
                        onClick={() => dispatch(setStartIndex(0))}
                      >
                        Unemployment
                      </Link>
...
export default InactiveIncomeCriteria;
